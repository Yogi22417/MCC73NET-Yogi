...
public class RoleController : BaseController<RolesRepositories, Role, int>
{
    public RoleController(RolesRepositories repositories) : base(repositories) { }
    ...
    //    try
    //    {
    //        var result = _repositories.Update(role);
    //        return result == 0
    //            ? Ok(new { message = $"Id {role.Id} Tidak Ditemukan" })
